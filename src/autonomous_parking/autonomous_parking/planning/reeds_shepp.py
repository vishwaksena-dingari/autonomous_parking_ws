...
Co-author: Videh Patel (@videh25)
Adapted for Autonomous Parking Project
"""
...
def reeds_shepp_path_planning(sx, sy, syaw, gx, gy, gyaw, maxc, step_size=0.2):
    """
    Get the shortest Reeds-Shepp path from start to goal.
    ...
    Args:
        ...
        gy: Goal y
        gyaw: Goal yaw
        maxc: Max curvature (1/min_radius)
        step_size: Step size for interpolation
        
    Returns:
        xs, ys, yaws, ctypes, lengths
    """
